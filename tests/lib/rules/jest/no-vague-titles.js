...
function errorWithMethod(method, type = 'CallExpression') {
  return [
    {
      type,
...
ruleTester.run('no-vague-titles', rule, {
  ...
  invalid: [
    ...
    },
    {
      ...
      parser,
      errors: errorWithMethod('it', 'MemberExpression'),
    },
    {
    ...
    },
    {
      ...
      parser,
      errors: errorWithMethod('describe', 'MemberExpression'),
    },
    {
    ...
    },
    {
      ...
      parser,
      errors: errorWithMethod('test', 'MemberExpression'),
    },
    {
